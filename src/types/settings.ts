...
export const DEFAULT_USER_SETTINGS: UserSettingsInsert = {
  ...
  products: [
    ...
    },
    {
      ...
      description: '差別化したい店舗様向けに、施設オリジナルラベルやオリジナルレシピのクラフトコーラをOEM製造。他施設が真似できないオンリーワンのドリンクを提供可能。',
      benefits: '施設の独自ブランディング、他施設との明確な差別化、話題性による集客効果、オリジナル商品としての販売で利益率向上',
    },
  ],
  value_propositions: [
  ...
  social_proof: '2025年1月発売、1年間で全国約54施設に導入。1年以上継続して取り扱っていただいている施設がほとんどで、リピート率の高さが実証済み。月間最大106万円の追加売上実績あり。',
