...
function demoClassify(content: string): { sentiment: Sentiment; reason: string; ai_response: string } {
  ...
  if (lower.includes('興味') || lower.includes('詳しく') || lower.includes('面談') || lower.includes('お会い')) {
    return {
      ...
      ai_response: 'お返事いただきありがとうございます。ぜひ詳しくご説明させていただければ幸いです。ご都合のよい日程をいくつかお知らせいただけますでしょうか。オンライン・対面どちらでも対応可能です。どうぞよろしくお願いいたします。',
    }
  }
  if (lower.includes('検討') || lower.includes('上司') || lower.includes('社内')) {
    return {
      ...
      ai_response: 'ご検討いただきありがとうございます。追加でご不明な点やご確認事項がございましたら、いつでもお気軽にご連絡ください。引き続きどうぞよろしくお願いいたします。',
    }
  }
  if (lower.includes('結構') || lower.includes('不要') || lower.includes('間に合って') || lower.includes('お断り')) {
    return {
      sentiment: 'お断り',
      reason: '不要・お断りの意思が明確',
      ai_response: 'ご返信いただきありがとうございます。今回はご縁がなかったとのこと、承知いたしました。またご状況が変わりましたら、いつでもお声がけいただければ幸いです。失礼いたします。',
    }
  }
  if (lower.includes('料金') || lower.includes('費用') || lower.includes('価格') || lower.includes('どのくらい') || lower.includes('?') || lower.includes('？')) {
    return {
      ...
      ai_response: 'ご質問いただきありがとうございます。詳細についてご説明させていただきます。別途、資料をお送りすることも可能です。またご不明な点があれば、お気軽にご連絡ください。',
    }
  }
  return {
    sentiment: 'その他',
    reason: '特定カテゴリに該当しない返信',
    ai_response: 'ご返信いただきありがとうございます。引き続きご不明な点などございましたら、いつでもお気軽にお問い合わせください。どうぞよろしくお願いいたします。',
  }
}
