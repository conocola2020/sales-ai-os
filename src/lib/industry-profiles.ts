...
export const INDUSTRY_PROFILES: Partial<Record<Industry, IndustryMessageProfile>> = {
  ...
  フレンチ: {
    ...
    proofLine:
      '2024年にはパリコレクションでの提供実績があり、ラグジュアリーホテルのコンラッドホテルでもご提供いただいております。',
    secondProposal:
      'また、レストランオリジナルレシピのOEMも承っており、コースの世界観に合わせた一杯を共同開発することも可能です。',
    dmMessage: name =>
      `はじめまして、CONOCOLAの河野と申します。${name}さんのお料理の投稿を拝見し、ご連絡いたしました。名古屋で生薬とスパイス10種のクラフトコーラを作っており、パリコレクションやコンラッドホテルでの提供実績もございます。お酒を飲まれないお客様へのノンアルコールペアリングとして、ご興味ございませんか？`,
  },
  ...
  百貨店: {
    ...
    productDetail:
      '2024年パリコレクションでの提供、ラグジュアリーホテルのコンラッドホテルでの提供、アニメIP・球場とのコラボ実績など、催事の集客につながる話題性をご用意できます。',
    proofLine: 'NHKをはじめとするメディア掲載多数、全国60以上の店舗・施設での導入実績がございます。',
    secondProposal: 'また、百貨店様限定パッケージのOEMもご相談可能です。',
    dmMessage: name =>
      `はじめまして、CONOCOLAの河野と申します。${name}様の催事や地元名品の取り組みを拝見し、ご連絡いたしました。名古屋発のクラフトコーラで、パリコレクションやコンラッドホテルでの提供実績がございます。催事やギフトの文脈でご紹介の機会をいただくことは可能でしょうか？`,
  },
  ...
  高級食品スーパー: {
    ...
    productDetail:
      '2024年パリコレクションでの提供実績に加え、ラグジュアリーホテルのコンラッドホテルでもご提供いただいており、価格帯に見合うブランドストーリーを備えています。瓶のデザイン性からギフト・手土産用途でも動きやすい商品です。',
    proofLine: 'NHKをはじめとするメディア掲載多数、全国60以上の店舗・施設での導入実績がございます。',
    secondProposal: 'また、店舗限定ラベルのOEMもご相談可能です。',
    dmMessage: name =>
      `はじめまして、CONOCOLAの河野と申します。${name}さんの品揃えの投稿を拝見し、ご連絡いたしました。名古屋で無添加・生薬10種のプレミアムクラフトコーラを作っており、パリコレクションやコンラッドホテルでの提供実績もございます。ギフト向け商品の新規お取り扱いって、ご検討されることありますか？`,
  },
  ...
  高級レストラン: {
    ...
    proofLine:
      '2024年のパリコレクションでの提供実績があり、ラグジュアリー層に向けてはコンラッドホテルでもご提供いただいております。',
    secondProposal:
      'また、お店オリジナルレシピのOEMも承っており、コースの世界観に合わせた一杯を共同開発することも可能です。',
    dmMessage: name =>
      `はじめまして、CONOCOLAの河野と申します。${name}さんのお料理の投稿を拝見し、ご連絡いたしました。名古屋で生薬とスパイス10種のクラフトコーラを作っており、パリコレクションやコンラッドホテルでの提供実績もございます。お酒を召し上がらないお客様へのノンアルコールペアリングとして、ご興味ございませんか？`,
  },
}
