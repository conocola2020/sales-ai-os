...
export const INDUSTRY_PROFILES: Partial<Record<Industry, IndustryMessageProfile>> = {
  ...
  フレンチ: {
    ...
    productDetail: '',
    proofLine:
      '2024年にはパリコレクションでの提供実績があり、外資系ラグジュアリーホテルでのご提供も決定しております。',
    secondProposal: null,
    dmMessage: name =>
      `はじめまして、CONOCOLAの河野と申します。${name}さんのお料理の投稿を拝見し、ご連絡いたしました。名古屋で生薬とスパイス10種のクラフトコーラを作っており、パリコレクションでの提供実績があり、外資系ラグジュアリーホテルでのご提供も決定しております。お酒を飲まれないお客様へのノンアルコールペアリングとして、ご興味ございませんか？`,
  },
  ...
  百貨店: {
    ...
    productDetail:
      '2024年パリコレクションでの提供、ラグジュアリーホテルの外資系ラグジュアリーホテルでの提供決定、アニメIP・球場とのコラボ実績など、催事の集客につながる話題性をご用意できます。',
    proofLine: 'NHKをはじめとするメディア掲載多数、全国60以上の店舗・施設での導入実績がございます。',
    secondProposal: 'また、百貨店様限定パッケージのOEMもご相談可能です。',
    dmMessage: name =>
      `はじめまして、CONOCOLAの河野と申します。${name}様の催事や地元名品の取り組みを拝見し、ご連絡いたしました。名古屋発のクラフトコーラで、パリコレクションでの提供実績があり、外資系ラグジュアリーホテルでのご提供も決定しております。催事やギフトの文脈でご紹介の機会をいただくことは可能でしょうか？`,
  },
  ...
  高級食品スーパー: {
    ...
    productDetail:
      '2024年パリコレクションでの提供実績に加え、外資系ラグジュアリーホテルでのご提供も決定しており、価格帯に見合うブランドストーリーを備えています。瓶のデザイン性からギフト・手土産用途でも動きやすい商品です。',
    proofLine: 'NHKをはじめとするメディア掲載多数、全国60以上の店舗・施設での導入実績がございます。',
    secondProposal: 'また、店舗限定ラベルのOEMもご相談可能です。',
    dmMessage: name =>
      `はじめまして、CONOCOLAの河野と申します。${name}さんの品揃えの投稿を拝見し、ご連絡いたしました。名古屋で無添加・生薬10種のプレミアムクラフトコーラを作っており、パリコレクションでの提供実績があり、外資系ラグジュアリーホテルでのご提供も決定しております。ギフト向け商品の新規お取り扱いって、ご検討されることありますか？`,
  },
  ...
  高級レストラン: {
    ...
    productDetail: '',
    proofLine:
      '2024年のパリコレクションでの提供実績があり、ラグジュアリー層に向けては外資系ラグジュアリーホテルでのご提供も決定しております。',
    secondProposal: null,
    dmMessage: name =>
      `はじめまして、CONOCOLAの河野と申します。${name}さんのお料理の投稿を拝見し、ご連絡いたしました。名古屋で生薬とスパイス10種のクラフトコーラを作っており、パリコレクションでの提供実績があり、外資系ラグジュアリーホテルでのご提供も決定しております。お酒を召し上がらないお客様へのノンアルコールペアリングとして、ご興味ございませんか？`,
  },
}
