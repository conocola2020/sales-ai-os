  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-xl font-bold text-gray-900">MEO / AIO ダッシュボード</h1>
        ...
        <section className="bg-white border border-gray-200 rounded-2xl overflow-hidden">
          <div className="px-5 py-4 border-b border-gray-200 flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <h2 className="text-sm font-bold text-gray-900">最近の口コミ</h2>
            </div>
            <Link
              href="/meo/reviews"
              className="text-xs text-violet-600 hover:text-violet-600 inline-flex items-center gap-1"
            >
              ...
              <div key={r.id} className="px-5 py-4">
                <div className="flex items-center justify-between mb-1.5">
                  <div className="flex items-center gap-3">
                    <span className="text-sm text-gray-900 font-medium">{r.author}</span>
        ...
        <section className="bg-white border border-gray-200 rounded-2xl overflow-hidden">
          <div className="px-5 py-4 border-b border-gray-200 flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <h2 className="text-sm font-bold text-gray-900">AIリスティング</h2>
            </div>
            <Link
              href="/meo/citations"
              className="text-xs text-violet-600 hover:text-violet-600 inline-flex items-center gap-1"
          ...
          <div className="px-5 py-4 border-t border-gray-200">
            <Link
              href="/meo/aio"
              className="inline-flex items-center gap-2 text-sm text-violet-600 hover:text-violet-600 font-medium"
            >
