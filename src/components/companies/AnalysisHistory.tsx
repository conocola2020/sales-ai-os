      ...
      <div className="flex items-start gap-2.5 p-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1.5 flex-wrap">
            ...
            {analysis.industry && (
              <span className="text-xs px-1.5 py-0.5 bg-gray-200 rounded text-gray-400">
                {analysis.industry}
              </span>
            )}
          </div>
          <div className="flex items-center gap-1 mt-0.5">
            ...
            <span className="text-xs text-gray-400">{timeAgo(analysis.created_at)}</span>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between mb-3">
        <h3 className="text-sm font-semibold text-gray-900">分析履歴</h3>
        {analyses.length > 0 && (
      ...
      {analyses.length === 0 ? (
        <div className="flex flex-col items-center justify-center flex-1 py-12 text-center">
          ...
          <p className="text-xs text-gray-400 mt-1">分析するとここに表示されます</p>
        </div>
      ) : (
